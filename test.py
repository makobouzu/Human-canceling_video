...
if __name__ == "__main__":
    ...
    # General parameters
    parser.add_argument('--results_path', type = str, default = '../resize/car_results', help = 'testing samples path that is a folder')
    ...
    # Dataset parameters
    parser.add_argument('--baseroot', type = str, default = '../resize/frames')
    parser.add_argument('--baseroot_mask', type = str, default = '../resize/car_mask')
